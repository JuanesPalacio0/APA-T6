...
A continuación se muestra una captura de pantalla con el resultado de ejecutar el archivo `alumno.py` usando la opción `verbose` de `doctest`, que muestra la ejecución detallada de las pruebas:

![Resultado de pruebas](test_alumno_output.png)
